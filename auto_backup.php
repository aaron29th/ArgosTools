...
file_put_contents('/home/retsluxybf/aaronrosser/argos/backup/fourDigitCatNums/' . gmdate("d-m-y") . '.js', $fourDigitJsFile);

$catNumsJsFile = 'products = [' . implode(',', $catNums) . ']; let updatedCatNumsLoaded = true;';
file_put_contents('/home/retsluxybf/aaronrosser/argos/backup/products/' . gmdate("d-m-y") . '.js', $catNumsJsFile);